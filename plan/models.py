...
class ProductClassesPlan(AbstractEntity):
    ...
    unit = models.CharField(max_length=8, help_text='单位', verbose_name='单位', default="kg")
...
class MaterialRequisitionClasses(AbstractEntity):
    ...
    plan_classes_uid = models.CharField(max_length=64, verbose_name='班次计划唯一码', help_text='班次计划唯一码')
